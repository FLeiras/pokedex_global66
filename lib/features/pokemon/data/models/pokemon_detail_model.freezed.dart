...
class _$PokemonDetailModelImpl implements _PokemonDetailModel {
  ...
  @override
  String toString() {
    return 'PokemonDetailModel(id: $id, name: $name, height: $height, weight: $weight, types: $types, ability: $ability)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, height, weight,
      const DeepCollectionEquality().hash(_types), ability);
...
abstract class _PokemonDetailModel implements PokemonDetailModel {
  const factory _PokemonDetailModel(
      ...
      required final List<String> types,
      required final String ability}) = _$PokemonDetailModelImpl;
